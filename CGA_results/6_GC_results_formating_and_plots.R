...
write.table(Table_results_uniq, 
            file = paste("/Users/christianarenasdaza/Desktop/lab_ch2/output/6_QC_and_association_test/SPMsRG_logistic_add_results.tsv.tab", sep = ""),
            sep = "\t",
            quote = FALSE,
            row.names = FALSE)
...
# Group databy chromosome and position
Table_results_uniq <- Table_results_uniq %>% 
  group_by(CHR, BP)
