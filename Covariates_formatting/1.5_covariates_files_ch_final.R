...
write.table(covariates_final, 
            file = paste("/Users/christianarenasdaza/Desktop/lab_ch2/output/1.5_covariates_file_ch/covariates_file_full_AST_ch.tab", sep = ""),
            sep = "\t",
            quote = FALSE,
            row.names = FALSE)  

write.table(covariates_final_no_NA, 
            file = paste("/Users/christianarenasdaza/Desktop/lab_ch2/output/1.5_covariates_file_ch/covariates_file_AST_ch.tab", sep = ""),
            sep = "\t",
            quote = FALSE,
            row.names = FALSE)  

write.table(dummy_covariates_final, 
            file = paste("/Users/christianarenasdaza/Desktop/lab_ch2/output/1.5_covariates_file_ch/covariates_dummy_AST_ch.tab", sep = ""),
            sep = "\t",
            quote = FALSE,
            row.names = FALSE)  

write.table(dummy_covariates_no_sex, 
            file = paste("/Users/christianarenasdaza/Desktop/lab_ch2/output/1.5_covariates_file_ch/covariates_dummy_no_sex_ASTHM.tab", sep = ""),
            sep = "\t",
            quote = FALSE,
            row.names = FALSE) 
